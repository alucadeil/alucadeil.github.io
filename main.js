//
// @author Aleksandr Frolov
// @group 721701
// Лабораторная работа 2
// Вариант 9 -  Построение СДНФ для заданной формулы
//
...
function main() {
    ...
    if (!syntaxValidationResult) {
        ...
        messageText.innerHTML = "Введена неверная формула";
    ...
    for (valueSetNumber = 0; valueSetNumber < positiveResultValueSets.length; valueSetNumber++) {
        ...
        // fill group with variables, dividing them with '&('
